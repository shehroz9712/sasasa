...
<!-- Hero Sectin Start -->
<section class=" container-fluid overflow-visible  promotion-section-bg promotion-section-bg-before promotion-section-bg-after pormotions-hero-height-responsive vh-100">
    ...
    <div class="align-items-center d-flex flex-column gap-5 h-100">
      ...
      <span class="w-100 w-md-75">
        <a href="https://wa.me/971547935400" target="_blank" class="w-100 h-100">
          <img src="assets/img/up-pro-hero-bottom.png" class="pormotions-hero-img-margin-top-responsive" alt="Location 1">
        </a>
      </span>
    </div>
  </div>
    ...
    <div class="row row-cols-lg-3 justify-content-center">
      <div class="promotions-box-hover-effect">
        <div class="shadow px-0 rounded-5">
          ...
          <div class="align-items-end blag-img-1 d-flex justify-content-end pb-3 px-4 rounded-5 text-white  blog-box-height">
      ...
      <div class="promotions-box-hover-effect">
        <div class="shadow px-0 rounded-5">
          ...
          <div class="align-items-end blag-img-2  d-flex justify-content-end pb-3 px-4 rounded-5 text-white  blog-box-height">
      ...
      <div class="promotions-box-hover-effect">
        <div class="shadow px-0 rounded-5">
          ...
          <div class="align-items-end blag-img-3  d-flex justify-content-end pb-3 px-4 rounded-5 text-white  blog-box-height">
