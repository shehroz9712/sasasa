<section>
    <div class="container  px-4">
        <div class="row">
            <div class="col-lg-8">
                <h2 class="level-2 heading-font text-wrapper dark-color"> Your Key to Perfect Drive </h2>
                <p class="level-7 primary-light-font dark-color ">As a leading Auto Repair Center in Dubai, we take pride in delivering exceptional solutions for all your car needs. With years of experience, we uphold our vision daily, ensuring that quality service is never compromised.</p>
            </div>
            <div class="col-lg-4">
                <div class="d-flex flex-column gap-3 gateway-btn-wrapper w-100">
                    <a href="https://wa.me/971547935400" target="_blank" class="align-self-baseline align-self-lg-end btn fs-6 w-100 w-md-75">Avail Your Discount</a>
                    <a href="tel:+971 56 545 8853" target="_blank" class="align-self-baseline align-self-lg-end btn fs-6 transparent-btn w-100 w-md-75">Call Now</a>
                </div>
            </div>
        </div>
    </div>
...
<style>
    .gateway-height-responsive {
        height: 15rem;
    }

    .gateway-height-responsive-2 {
        height: 20rem;
    }

    .gateway-service-img-width-height-responsive {
        height: 100%;
    }

    .gateway-img-width-height-responsive-1::after {
        background: url(./assets/img/gateway-new-img-Transmission-Repair.jpg) no-repeat center center/cover;
    }

    .gateway-img-width-height-responsive-2::after {
        background: url(./assets/img/gateway-new-img7.jpg) no-repeat center center/cover;
    }

    .gateway-img-width-height-responsive-3::after {
        background: url(./assets/img/gateway-new-img2.jpg) no-repeat center center/cover;
    }

    .gateway-img-width-height-responsive-4::after {
        background: url(./assets/img/gateway-new-img-Car-AC-Repair.jpg) no-repeat center center/cover;
    }

    .gateway-img-width-height-responsive-5::after {
        background: url(./assets/img/gateway-new-img-Car-Painting.jpg) no-repeat center center/cover;
    }

    .gateway-img-width-height-responsive-6::after {
        background: url(./assets/img/gateway-new-img4.jpg) no-repeat center center/cover;
    }

    .gateway-img-width-height-responsive-7::after {
        background: url(./assets/img/gateway-new-img-Car-Restoration.jpg) no-repeat center center/cover;
    }

    .gateway-img-width-height-responsive-8::after {
        background: url(./assets/img/gateway-new-img-Car-Tint.jpg) no-repeat center center/cover;
    }
</style>
