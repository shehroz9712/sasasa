    ...
    <div class="container auto-text-bg">
        <div class="row g-4">
            ...
            <div class="col-md-6 my-auto">
                <img src="assets/img/German-car-section-img.png" alt="" class="Chinese-Car-Partner-right-car mt-5">
            </div>
...
<div class="auto-spa-full-container-bg container-fluid d-flex flex-column gap-4 justify-content-center px-5" style="height: 50vh;">
    <div class="container">
        <div class="g-3 g-md-0 row">
            <div class="col-md-7">
                <h3 class="ceramic-full-container-top-heading-responsive fw-light text-white">Your Trusted Partner for</h3>
                <h2 class="ceramic-full-container-main-heading-responsive fw-bolder text-white">German Car Repairs & Sales in Dubai</h2>
