...
<section class="all-pages-hero-height-responsive container-fluid position-relative european-Car-hero-bg overflow-visible vh-100">
    ...
    <div class="row align-items-md-center h-100 ">
      <div class="col-md-6 d-flex flex-column gap-4">
        ...
        <div class="d-flex flex-column flex-md-row flex-wrap gap-4">
          ...
          <a href="tel:+971 56 545 8853" target="_blank"> <button class="bg-transparent border-2 border-dark btn fs-6 fw-bold px-5 text-dark ">Call
              Now</button></a>
        </div>
      </div>
  ...
  <div class="container auto-text-bg">
    <div class="row g-4">
      ...
      <div class="col-md-6 my-auto">
        <img src="assets/img/European-Car-section-car.png" alt="" class="Chinese-Car-Partner-right-car mt-5">
      </div>
      <div class="col-md-6 d-flex flex-column justify-content-center gap-3">
        ...
        <a href="tel:+971 56 545 8853" target="_blank"><button class="btn fs-6 fw-bold w-50">Call Now</button></a>
      </div>
  ...
  <div class="container">
    <div class="g-3 g-md-0 row">
      <div class="col-md-7">
        ...
        <h2 class="ceramic-full-container-main-heading-responsive fw-bolder text-white">European Car Experts in Dubai</h2>
