...
<section class="container-fluid   general-repair-form-bg overflow-visible ">
  <div class="container h-100 w-100">
    ...
    <img src="assets/img/gr-form-car-collection.png" alt="" class="img-fluid d-none d-md-block" style="margin-bottom: -7rem;">
  </div>
</section>
<!-- Form Section  End-->
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-6 my-auto">
        <img src="assets/img/service-partner-right.png" alt="" class="img-fluid mt-5 w-100">
      </div>
    </div>
  </div>
</section>
...
<section class="align-items-center container d-flex flex-column justify-content-center mx-auto text-center gap-3">
  ...
  <img src="assets/img/services-solution.png" alt="" class="img-fluid w-100">
