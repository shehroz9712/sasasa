    ...
    <div class="row align-items-center about-our-team-responsive-padding">
      <div class="col-lg-5" style="float: left;">
        <div class="our-team-top">
          <img src="assets/img/our-team-left.png" style="box-shadow: 6px 4px 4px #ccc; border-radius: 0px 20px;" alt="">
        </div>
      </div>
      <div class="about-us-our-team-text-padding-responsive col-lg-6 mt-4 mt-md-0">
        ...
        <p class="about-us-our-team-text-aling-responsive">At Gargash Auto, our team is the backbone of our exceptional service. Comprising highly experienced automotive professionals from around the world, we specialize in working with luxury cars using the latest diagnostic tools and advanced technology. From rebuilding engines and gearboxes to providing meticulous repairs and maintenance, our team brings a wealth of expertise to every project. We are dedicated to ensuring your vehicle receives the highest quality care, and we pride ourselves on creating a transparent, customer-focused experience. With a commitment to excellence, our team is here to deliver unmatched service for your luxury car needs.</p>
        <a href="https://wa.me/971547935400" target="_blank"><button class="btn fs-6 fw-semibold rounded-3">Click here for more Offers</button></a>
      </div>
...
<section class="container py-md-4">
  <div class="row d-flex  flex-md-row align-items-center">
    <div class="col-md-6 text-start">
      ...
      <p class="about-us-our-team-text-aling-responsive">At Gargash Auto, our vision is to deliver seamless, reliable, and top-quality car repair solutions that exceed customer expectations. We are dedicated to staying ahead of the curve by adopting the latest technologies and innovations to enhance our services and ensure the best care for your vehicle.</p>
      <div class="d-flex justify-content-center justify-content-md-start">
        <a href="https://wa.me/971547935400" target="_blank" class="btn fs-6 fw-semibold rounded-3"> Click here for more Offers </a>
      </div>
    </div>
    <div class="col-md-6 d-flex justify-content-center mt-4 mt-md-0">
      <img class="mt-5 mt-md-0 w-75 w-md-100" src="assets/img/vision-section-right.png" alt="hero" />
    </div>
  </div>
</section>
